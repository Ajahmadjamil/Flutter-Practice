...
import 'package:flutterpractices/Features/ToDoReminder/ui/Widget/input_field.dart';
...
class _AddTaskPageState extends State<AddTaskPage> {
  ...
  Future<TimeOfDay?> _showTimePicker() {
    ...
    if (timeParts[1].toLowerCase() == "am" && hour == 12) {
      hour = 0;
    }
  ...
  return AppBar(
    ...
    leading: GestureDetector(
      ...
      child: Icon(Icons.arrow_back_ios,
          color: Get.isDarkMode ? Colors.white : Colors.black, size: 20),
    ),
    actions: const [
      CircleAvatar(
